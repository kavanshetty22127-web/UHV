...
- **Waiting Room**: Users wait in a dedicated lobby until the admin starts the session
...
3. **Waiting Room**: After logging in, you'll be taken to a waiting room until the admin starts the session
4. **Quiz**: Answer 15 random questions (admin must add questions first)
5. **Timer**: Each question has a timer (default 30 seconds, configurable by admin)
6. **Scoring**: Each correct answer gives you 1 point
7. **Results**: See your final score at the end

## Admin Panel

- Login as "ADMIN2007" to view all registered users
- The list updates automatically as new users play the quiz
- **Session Control**: Start or end the quiz session for all users

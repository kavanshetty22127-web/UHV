...
let sessionActive = localStorage.getItem('quizSessionActive') === 'true' || false;
...
loginBtn.addEventListener('click', () => {
    ...
    if (!sessionActive) {
        loginError.textContent = 'Quiz session has not started yet. Please wait for admin to start the session.';
        return;
    }

...
function updateAdminUsersList() {
    ...
    // Update leaderboard (sorted by completion time)
    ...
    // Sort by completion time (earliest finishers first)
        ...
        completedUsers.forEach((userData, index) => {
            ...
            listItem.innerHTML = `
                ...
                <span style="float: right; color: #00fff7;">
                    Score: ${userScore.score}/${userScore.total} - Finished at: ${userScore.date}
                </span>
            `;
